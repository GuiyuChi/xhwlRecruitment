...
## 管理员查看 部门笔试 记录 get {{8080}}/admin/DepartmentWritten/31？page=1&size=10 (数字为岗位id）
```
不输入page默认为1和size默认为10
需要管理员的 token
正确返回如下， auth表示管理员能否操作该条投递记录，0表示不可以，1表示可以操作
...
## 管理员查看 已通过 记录 get  {{8080}}/admin/Pass/32？page=1&size=10  (数字为岗位id）
```
不输入page默认为1和size默认为10
需要管理员的 token
...
## 管理员查看岗位中的 已拒绝 记录 get {{8080}}/admin/Refuse/31?page=1&size=1 (数字为岗位id）
```
不输入page默认为1和size默认为10
需要管理员的 token
正确返回如下， auth表示管理员能否操作该条投递记录，0表示不可以，1表示可以操作
