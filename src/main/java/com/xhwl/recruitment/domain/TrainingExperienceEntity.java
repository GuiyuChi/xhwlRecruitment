 ...
 * @Author: guiyu
 * @Description:
 * @Date: Create in 下午10:00 2018/4/7
 **/
@Entity
@Table(name = "training_experience", schema = "xhwl", catalog = "")
public class TrainingExperienceEntity {
    private long id;
    ...
    public boolean equals(Object o) {
        ...
        TrainingExperienceEntity that = (TrainingExperienceEntity) o;
        return id == that.id &&
    ...
    public String toString() {
        return "TrainingExperienceEntity{" +
                "id=" + id +
                ", resumeId=" + resumeId +
                ", startTime=" + startTime +
                ", endTime=" + endTime +
