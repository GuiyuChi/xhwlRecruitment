 ...
 **/
@Entity
@Table(name = "dw_work_experience", schema = "xhwl", catalog = "")
public class DwWorkExperienceEntity {
    private long id;
    ...
    public boolean equals(Object o) {
        ...
        DwWorkExperienceEntity that = (DwWorkExperienceEntity) o;
        return id == that.id &&
