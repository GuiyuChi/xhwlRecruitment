 ...
 * @Author: guiyu
 * @Description:
 * @Date: Create in 下午11:39 2018/4/14
 **/
@Entity
@Table(name = "internship_experience", schema = "xhwl", catalog = "")
public class InternshipExperienceEntity {
    private long id;
    ...
    public boolean equals(Object o) {
        ...
        InternshipExperienceEntity that = (InternshipExperienceEntity) o;
        return id == that.id &&
